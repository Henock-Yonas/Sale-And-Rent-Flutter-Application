...
class SearchSaleDetail extends StatefulWidget {
  QuerySnapshot<Map<String, dynamic>> usermap;
  

  SearchSaleDetail(this.usermap, {Key? key}) : super(key: key);
...
class _RentAddLSState extends State<SearchSaleDetail> {
