...
import 'package:folisho/SearchRentDetail.dart';
...
class SearchRent extends StatefulWidget {
  ...
  SearchRent(this.usermap);

  @override
  _RentAddLSState createState() => _RentAddLSState();
}

class _RentAddLSState extends State<SearchRent> {
  @override
    ...
    onsearch() {
      ...
      _firestore
        ...
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => SearchRentDetail(value)));
      });
    }
