...
import 'package:folisho/model/saleRegistration_Model.dart';
import 'package:folisho/theme.dart';
import 'package:intl/intl.dart';
import 'model/Registration_Model.dart';

class SaleRegistrationPage extends StatefulWidget {
  const SaleRegistrationPage({Key? key}) : super(key: key);
...
class _RegistrationPageState extends State<SaleRegistrationPage> {
  final saleRegistrationModel rentModel = saleRegistrationModel();
  ...
  postDetailsToFirestore() {
    ...
    saleRegistrationModel registrationModel = saleRegistrationModel();
