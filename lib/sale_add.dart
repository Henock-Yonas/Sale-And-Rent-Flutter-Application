...
class sale_add extends StatefulWidget {
  final SaleModel saleModel;

  sale_add({required this.saleModel});

  get userId => null;

  @override
  _sale_addState createState() => _sale_addState();
}

class _sale_addState extends State<sale_add> {
  final SaleModel saleModel = SaleModel();
...
//   }
  ...
  postDetailsToFirestore(
    ...
    saleModel.kindofhome = kindofController.text;
    saleModel.address = addressController.text;
    saleModel.name = nameController.text;
    saleModel.phoneNumber = phonenumberController.text;
    saleModel.image = downloadURL;
    saleModel.detailImage = downloadURL1;
    saleModel.detailImage2 = downloadURL2;
    saleModel.detailImage3 = downloadURL3;
    saleModel.explanation = explanationController.text;
    saleModel.price = priceController.text;
    saleModel.uid = dr.id;
    firebaseFirestore
        .collection("sale")
        .doc(saleModel.uid)
